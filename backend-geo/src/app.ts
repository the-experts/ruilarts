 ...
 * example call1  http://localhost:4000/route?fromLon=5.03239361&fromLat=52.12244549&toLon=5.05239361&toLat=52.12244549
...
/**
 * route local uses a local graphhopper
 * example call1  http://localhost:4000/route?fromLon=5.03239361&fromLat=52.12244549&toLon=5.05239361&toLat=52.12244549
 * returns weight + distance but can be extended by much more...!
 */
app.get('/route-local', async (req, res) => {
    const fromLon = parseFloat(req.query.fromLon)
    const fromLat = parseFloat(req.query.fromLat)
    const toLon = parseFloat(req.query.toLon)
    const toLat = parseFloat(req.query.toLat)
    const transportProfile = req.query.transportProfile
